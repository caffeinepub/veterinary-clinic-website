    ...
    <div className="py-10">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10">
          <span className="text-sm font-semibold text-primary uppercase tracking-widest">Medical Care</span>
          <h1 className="font-serif text-3xl sm:text-4xl font-bold text-foreground mt-2 mb-3">
            Treatment Management
          </h1>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Comprehensive treatment services organized by animal category. Click on any treatment to view full details and pricing.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            {treatmentServices.length === 0 && (
              <div className="text-center py-16">
                ...
                <h3 className="font-serif text-xl font-semibold text-foreground mb-2">No treatments listed yet</h3>
                <p className="text-muted-foreground">Treatment services will appear here once added by the clinic.</p>
              </div>
            )}
          </div>
        )}
