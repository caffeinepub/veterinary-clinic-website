    ...
    <div className="py-10">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10">
          <span className="text-sm font-semibold text-primary uppercase tracking-widest">Our Offerings</span>
          <h1 className="font-serif text-3xl sm:text-4xl font-bold text-foreground mt-2 mb-3">
            All Veterinary Services
          </h1>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Browse our complete range of veterinary services for large ruminants, small ruminants, and pets.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="font-serif text-xl font-semibold text-foreground mb-2">No services found</h3>
