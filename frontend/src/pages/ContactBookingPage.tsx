...
import { useGetAllServices, useBookAppointment } from '../hooks/useQueries';
import AppointmentBookingForm, { type BookingFormData } from '../components/AppointmentBookingForm';
import BookingConfirmation from '../components/BookingConfirmation';
import { generateAppointmentId, dateToTime } from '../utils/appointmentHelpers';
import { Phone, MapPin, Clock, AlertTriangle, Users } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Fill out the form below to request an appointment. Our standby veterinary specialist will confirm your booking promptly.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-5">
            <div className="bg-card rounded-2xl border border-border p-6 shadow-xs">
              <h3 className="font-serif text-lg font-bold text-foreground mb-4">Clinic Information</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      treatVET, Tulatali<br />
                      (In front of Padua High School)<br />
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-primary font-medium">24/7 — Always Available</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Standby veterinary specialist on call</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-primary/10 shrink-0">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground">Service Hours</p>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground">Our Team</p>
                    <p className="text-sm text-muted-foreground">4+ Veterinary Experts · Est. 2017</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-primary/10 rounded-2xl border border-primary/20 p-5">
              <h4 className="font-semibold text-foreground mb-2 text-sm">📋 What to Bring</h4>
            ...
            <div className="bg-yellow-50 rounded-2xl border border-yellow-200 p-5">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-foreground text-sm">Emergency House Visit</h4>
              </div>
              <p className="text-sm text-muted-foreground">
                In emergency cases, our veterinary team visits the animal owner's house at <strong>any time</strong>. We are available 24/7 for urgent situations.
              </p>
            </div>
          </div>
        </div>
