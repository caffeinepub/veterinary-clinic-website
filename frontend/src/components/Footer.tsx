...
export default function Footer() {
  ...
  const appId = encodeURIComponent(typeof window !== 'undefined' ? window.location.hostname : 'treatvet-clinic');
      ...
      <div className="container mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm opacity-75 leading-relaxed mb-3">
              Expert veterinary care for pets, large animals, small animals, and birds/poultry. Serving the community since 2017.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-serif font-semibold text-base mb-4 opacity-90">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="font-serif font-semibold text-base mb-4 opacity-90">Contact Us</h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2.5 text-sm opacity-75">
                ...
                <div>
                  ...
                  <p className="text-xs opacity-80 mt-0.5">Standby veterinary specialist always available</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs opacity-60">
          ...
          <p className="flex items-center gap-1">
            Built with <Heart className="h-3 w-3 fill-current text-red-400" /> using{' '}
            <a
