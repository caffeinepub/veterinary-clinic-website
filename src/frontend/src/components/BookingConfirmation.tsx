...
import { Calendar, CheckCircle2, Phone, Tag, User } from "lucide-react";
  ...
  return (
    <div className="max-w-lg mx-auto text-center animate-fade-in">
      ...
      <p className="text-muted-foreground mb-6">
        Thank you, <strong>{clientName}</strong>! Your appointment request has
        been received. We'll confirm it shortly.
      </p>
      ...
      <div className="bg-card rounded-xl border border-border p-5 text-left space-y-3 mb-6 shadow-xs">
        ...
        <div className="pt-2 border-t border-border">
          <p className="text-xs text-muted-foreground">
            Reference ID:{" "}
            <code className="font-mono text-primary">{appointmentId}</code>
          </p>
        </div>
      </div>
