...
const categoryOptions = [
  ...
  {
    value: ServiceCategory.largeRuminant,
    label: "Large Animal (Cattle, Buffalo, Camel)",
  },
  { value: ServiceCategory.smallRuminant, label: "Small Animal (Sheep, Goat)" },
  {
    value: ServiceCategory.birdsPoultry,
    label: "Birds / Poultry (Layer, Broiler, Color Bird)",
  },
];
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          ...
          <Select
            ...
            onValueChange={(val) =>
              setFormData({
                ...formData,
                category: val as ServiceCategory,
                serviceId: "",
              })
            }
          >
        ...
        <div className="space-y-1.5">
          ...
          />
          {errors.animalType && (
            <p className="text-xs text-destructive">{errors.animalType}</p>
          )}
        </div>
      </div>
