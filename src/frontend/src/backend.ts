...
import type { Appointment as _Appointment, AppointmentStatus as _AppointmentStatus, Service as _Service, ServiceCategory as _ServiceCategory, ServiceType as _ServiceType, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async bookAppointment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ServiceCategory, arg5: string, arg6: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.bookAppointment(arg0, arg1, arg2, arg3, to_candid_ServiceCategory_n10(this._uploadFile, this._downloadFile, arg4), arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createService(arg0: string, arg1: string, arg2: string, arg3: ServiceCategory, arg4: ServiceType, arg5: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createService(arg0, arg1, arg2, to_candid_ServiceCategory_n10(this._uploadFile, this._downloadFile, arg3), to_candid_ServiceType_n12(this._uploadFile, this._downloadFile, arg4), arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAppointment(arg0: string): Promise<Appointment> {
        if (this.processError) {
            try {
                ...
                return from_candid_Appointment_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getAppointmentsByStatus(arg0: AppointmentStatus): Promise<Array<Appointment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppointmentsByStatus(to_candid_AppointmentStatus_n26(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServicesByType(arg0: ServiceType): Promise<Array<Service>> {
        if (this.processError) {
            try {
                const result = await this.actor.getServicesByType(to_candid_ServiceType_n12(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n21(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAppointmentStatus(arg0: string, arg1: AppointmentStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAppointmentStatus(arg0, to_candid_AppointmentStatus_n26(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateService(arg0: string, arg1: string, arg2: string, arg3: ServiceCategory, arg4: ServiceType, arg5: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateService(arg0, arg1, arg2, to_candid_ServiceCategory_n10(this._uploadFile, this._downloadFile, arg3), to_candid_ServiceType_n12(this._uploadFile, this._downloadFile, arg4), arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pet" in value ? ServiceCategory.pet : "birdsPoultry" in value ? ServiceCategory.birdsPoultry : "smallRuminant" in value ? ServiceCategory.smallRuminant : "largeRuminant" in value ? ServiceCategory.largeRuminant : value;
}
function from_candid_variant_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "vaccination" in value ? ServiceType.vaccination : "other" in value ? ServiceType.other : "treatment" in value ? ServiceType.treatment : "surgery" in value ? ServiceType.surgery : "consultation" in value ? ServiceType.consultation : value;
}
...
function to_candid_AppointmentStatus_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AppointmentStatus): _AppointmentStatus {
...
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceCategory): {
    ...
    return value == ServiceCategory.pet ? {
        pet: null
    } : value == ServiceCategory.birdsPoultry ? {
        birdsPoultry: null
    } : value == ServiceCategory.smallRuminant ? {
        smallRuminant: null
...
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceType): {
    ...
    return value == ServiceType.vaccination ? {
        vaccination: null
    } : value == ServiceType.other ? {
        other: null
    } : value == ServiceType.treatment ? {
        treatment: null
    } : value == ServiceType.surgery ? {
        surgery: null
    } : value == ServiceType.consultation ? {
        consultation: null
    } : value;
}
function to_candid_variant_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AppointmentStatus): {
    cancelled: null;
} | {
    pending: null;
} | {
